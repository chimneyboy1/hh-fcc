...
// Pick a random winner (verifiavbly random)
// Winner to be selected every X minutes -> completely automated

// Chainlink Oracle -> Randomness, Automated Eexcution(Chainlinl Keepers)
...
contract Raffle is VRFConsumerBaseV2, AutomationCompatible {
    ...
    /**
     * @dev This is the function that the Chainlinl Keeper nodes call
     * They look for the "upkeepNeeded" to return true
     * The following should be true in order to return true:
     * 1. Our time interval shoud havr passed
    ...
    function getaLatestTimeStamp() public view returns (uint256) {
